...
import com.yc.cepelin.model.*;

public class EventOverviewAdapter extends ArrayAdapter<EventOverview> {

    private ArrayList<EventOverview> items;
    
    public EventOverviewAdapter(Context context, int textViewResourceId, ArrayList<EventOverview> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
            ...
            EventOverview co = items.get(position);
