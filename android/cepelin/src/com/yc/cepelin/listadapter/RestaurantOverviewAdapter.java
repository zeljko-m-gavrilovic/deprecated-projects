...
public class RestaurantOverviewAdapter extends ArrayAdapter<RestaurantOverview> {

    private ArrayList<RestaurantOverview> items;
    
    public RestaurantOverviewAdapter(Context context, int textViewResourceId, ArrayList<RestaurantOverview> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
            ...
            RestaurantOverview co = items.get(position);
            
    	    String imgName="dist4";
    	    if (co != null) {
